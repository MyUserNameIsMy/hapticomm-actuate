...
# Ask user for channel and file selection
user_input = input("Enter the channel name and file number (e.g., 't1 2'): ")
channel_name, file_number = user_input.split()
file_key = f"Var_{file_number}"

# Find the channel number
channel_number = next((k for k, v in CHANNELS.items() if v[0] == channel_name), None)
if channel_number is None or file_key not in audio_files:
